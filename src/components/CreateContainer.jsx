      ...
      flex flex-col items-center justify-center gap-4">
        ...
        flex items-center gap-2'>
          ...
          <input
            ...
            className='w-full h-full text-lg bg-transparent p-1 
              ...
              <>
                ...
                items-center justify-center cursor-pointer'>
                  ...
                  items-center justify-center cursor-pointer">
                    ...
                    <p className='text-gray-500 text- hover:text-gray-700'>
        ...
        <div className="flex item0center w-full">
          <button
            type='button'
